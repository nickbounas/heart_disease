...
def submit():
    ...
    try:
        ...
        third.resizable(width=0, height=0) 
    ...
    if flag == 1:
        ...
        def my_confusion_matrix(y_test, y_pred, plt_title, accuracy_title):
            ...
            #plt.show()
            return cm
        my_confusion_matrix(y_test, y_pred, 'mlp CM', 'Accuracy with Mlp:')
...
path1 = 'C:/Users/nbounas/Downloads/FramingHam-main/Graphical user interface/heart-disease.jpg'
